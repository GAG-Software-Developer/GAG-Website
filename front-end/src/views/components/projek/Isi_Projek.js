            ...
            <Fragment>
                ...
                <Row className="align-items-center">
                    <div className="col-lg-7">
                        <img className="img-fluid mb-3 shadow-lg" src={require('../../../assets/projek_images/12.png')}></img>
                    </div>
                ...
                <Row className="align-items-center">
                    ...
                    <div className="col-lg-7">
                        <img className="img-fluid shadow-lg" src={require('../../../assets/projek_images/13.png')}></img>
                    </div>
                </Row>
                </Container>
            </Fragment>
