    ...
    return (
        <Navbar className="justify-content-around shadow p-3 mb-5 bg-white rounded" sticky="top" style={nav_colour}>
            <Nav style={{ fontWeight: "bold" }} >
                ...
                { props.selectedPage == "technology" ? ( <Link className="nav-link" style={text_selected} to="/technology">Code Labs</Link>) :  <Link className="nav-link" to="/technology">Laboratory</Link> }
